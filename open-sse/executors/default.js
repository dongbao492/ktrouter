...
export class DefaultExecutor extends BaseExecutor {
  ...
  async refreshCredentials(credentials, log, proxyOptions = null) {
    ...
    const refreshers = {
      ...
      xai: () => this.refreshXai(credentials.refreshToken, proxyOptions)
    };
  ...
  async refreshXai(refreshToken, proxyOptions = null) {
    const response = await proxyAwareFetch(PROVIDERS.xai.tokenUrl, {
      method: "POST",
      headers: { "Content-Type": "application/x-www-form-urlencoded", "Accept": "application/json" },
