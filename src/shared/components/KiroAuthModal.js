 ...
 * Google social login, AWS SSO device flow, or import token
 */
export default function KiroAuthModal({ isOpen, onMethodSelect, onClose }) {
  ...
  const handleIdcContinue = () => {
    if (!idcStartUrl.trim()) {
      setError("Please enter your IAM Identity Center start URL");
      return;
    }
      ...
      <div className="flex flex-col gap-4">
        ...
        {!selectedMethod && (
          <div className="space-y-3">
            ...
            {/* Google Social Login */}
            <button
              onClick={() => onMethodSelect("social", { provider: "google" })}
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-text-muted">
                    Login with the Kiro desktop Google flow.
                  </p>
                </div>
              </div>
            </button>
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-text-muted">
                    Use AWS SSO device authorization.
                  </p>
                </div>
              </div>
            </button>
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-text-muted">
                    Use your organization&apos;s AWS access portal.
                  </p>
                </div>
              </div>
            </button>
