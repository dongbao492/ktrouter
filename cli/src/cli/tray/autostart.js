...
const APP_LABEL = "com.ktrouter.autostart";
 ...
 *   2. `process.argv[1]` if it's our cli.js — true when ktrouter is currently
 ...
 * SIGTERM to the running process. When the running ktrouter cli.js was itself
...
<dict>
    ...
    <string>/tmp/ktrouter.log</string>
    <key>StandardErrorPath</key>
    <string>/tmp/ktrouter.error.log</string>
</dict>
</plist>`;
...
function enableWindows(cliPath) {
  ...
  // `ktrouter.cmd` lookup that depended on the npm prefix path.
