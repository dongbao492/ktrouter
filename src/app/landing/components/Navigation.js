    ...
    <nav className="fixed top-0 z-50 w-full bg-[#181411]/80 backdrop-blur-md border-b border-[#3a2f27]">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        >
          ...
          <h2 className="text-white text-xl font-bold tracking-tight">KTRouter</h2>
        </button>
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Link className="text-gray-300 hover:text-white text-sm font-medium transition-colors" href="/dashboard">Dashboard</Link>
        </div>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden border-t border-[#3a2f27] bg-[#181411]/95 backdrop-blur-md">
          <div className="flex flex-col gap-4 p-6">
            ...
            <Link className="text-gray-300 hover:text-white text-sm font-medium transition-colors" href="/dashboard" onClick={() => setMobileMenuOpen(false)}>Dashboard</Link>
            <button 
              onClick={() => router.push("/dashboard")}
