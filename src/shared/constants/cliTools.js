...
export const MITM_TOOLS = {
  antigravity: {
    ...
    modelAliases: ["gemini-3.5-flash-high", "gemini-3.5-flash-medium", "gemini-3.5-flash-low", "gemini-3.1-pro-high", "gemini-3.1-pro-low", "claude-sonnet-4-6-thinking", "claude-opus-4-6-thinking", "gpt-oss-120b-medium"],
    defaultModels: [
      ...
      { id: "gemini-3.5-flash-low", name: "Gemini 3.5 Flash (Low)", alias: "gemini-3.5-flash-low" },
...
export const CLI_TOOLS = {
  ...
  cowork: {
    ...
    configType: "custom",
    modelAliases: ["opus", "sonnet", "haiku", "codex", "kiro-sonnet"],
    defaultModels: [
      ...
      { id: "claude-haiku-4-5", name: "Claude Haiku 4.5", alias: "haiku", defaultValue: "cc/claude-haiku-4-5-20251001" },
      { id: "gpt-5.5", name: "GPT 5.5", alias: "codex", defaultValue: "cx/gpt-5.5" },
      { id: "kiro-claude-sonnet-4.6", name: "Kiro Claude Sonnet 4.6", alias: "kiro-sonnet", defaultValue: "kr/claude-sonnet-4.6" },
    ],
  },
  hermes: {
    id: "hermes",
